...
const CommunityCard: React.FC<CommunityCardProps> = ({
  name, avatar, distance, message, savings, rangeImprovement, likes, timeAgo, isPointoOwner, isUpgradePending, hasMedia
}) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
      ...
      {hasMedia && (
        <div className="w-full h-40 bg-gray-50 rounded-xl mb-3 flex items-center justify-center border border-gray-200">
          <ImageIcon />
        </div>
      )}
